...
Além do nosso YouTube, se liga no nosso site e agende para ficar por dentro de tudo que vai rolar em 2025

[teomehwy.org](https://teomehy.org/schedule)
...
02. `git clone <url-do-projeto-fork>`
03. `git checkout -b <nova-branch>`
04. alterações de arquivos
05. `git status`
06. `git add <arquivos>`
07. `git status`
08. `git commit -m "mensagem"`
09. `git status`
10. `git push origin <nova-branch>`
11. abrir Pull request no GitHub da branch fork para a `main` do projeto original
